...
public class CreditCardController {
    ...
    @PostMapping("/auth")
    public ResponseEntity<Boolean> authorizeCard(@RequestParam String cardNumber) {
    ...
    @GetMapping("/user_id")
    public ResponseEntity<List<CreditCard>> getCreditCardsByUserId(@RequestParam Integer userId) {
